...
if [[ $iptable_mangle_exit_code == 0 ]]; then
	...
	# setup route for sabnzbd webui http using set-mark to route traffic for port 6789 to lan interface
...
# accept input to sabnzbd webui port 6789
...
if [[ $iptable_mangle_exit_code == 0 ]]; then
	...
	# accept output from sabnzbd webui port 6789 - used for external access
...
# accept output from sabnzbd webui port 6789 - used for lan access
